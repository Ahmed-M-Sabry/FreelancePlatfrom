...
{
    public class AddAndRemoveFavoriteFromFreelancerHandler : ResponseHandler , IRequestHandler<AddAndRemoveFavoriteFromFreelancerCommand, ApiResponse<string>>
    {
        private readonly UserManager<ApplicationUser> _userManager;
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly IFavoritesFreelancerServices _favoritesFreelancerServices;
        public AddAndRemoveFavoriteFromFreelancerHandler(UserManager<ApplicationUser> userManager
        ...
        public async Task<ApiResponse<string>> Handle(AddAndRemoveFavoriteFromFreelancerCommand request, CancellationToken cancellationToken)
        {
            ...
            if (isFavorite != null)
            {
                ...
                return Deleted<string>("Freelancer removed from favorites.");
            }
