...
{
    public class AddAndRmoveJopbPostFavouriteHandler : ResponseHandler, IRequestHandler<AddAndRmoveJopbPostFavouriteCommand, ApiResponse<string>>
    {
        ...
        public AddAndRmoveJopbPostFavouriteHandler(UserManager<ApplicationUser> userManager
        ...
        public async Task<ApiResponse<string>> Handle(AddAndRmoveJopbPostFavouriteCommand request, CancellationToken cancellationToken)
        {
            ...
            if (isJobPostFavorite != null)
            {
                 ...
                 return Deleted<string>("Job post removed from favorites successfully.");
            }
            else
            {
                // Add to favorites
                ...
                return Created<string>("Job post added to favorites successfully.");
            }
