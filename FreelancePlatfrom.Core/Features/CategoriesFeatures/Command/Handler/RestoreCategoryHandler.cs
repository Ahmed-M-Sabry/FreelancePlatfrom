...
{
    public class RestoreCategoryHandler : ResponseHandler, IRequestHandler<RestoreCategoryCommand, ApiResponse<string>>
    {
        private readonly UserManager<ApplicationUser> _userManager;
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly ICategoryService _categoryService;
        private readonly IMapper _mapper;
        public RestoreCategoryHandler(UserManager<ApplicationUser> userManager
        ...
        public async Task<ApiResponse<string>> Handle(RestoreCategoryCommand request, CancellationToken cancellationToken)
        {
            ...
            if (!isCategoryExisted.IsDeleted)
                return BadRequest<string>($"{request.Id} Is Not Deleted");

            await _categoryService.RestoreCategory(request.Id);

            return Created<string>($"Category With id = {request.Id} is Restored");
        }
    }
}
